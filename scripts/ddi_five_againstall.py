...
# ============ LOAD DATASET ==============================
indexes = pd.read_csv('../data/5-list-unfiltered.txt', names=['row_ids']).row_ids.values
#print(indexes)
...
mask = [len(dd)==5 for dd in data.DrugBankID_sorted.values]
...
#=====================================================
log_file = f"../resultlogs/logger_logits_order_five_goldoffive_againstall_unfiltered_{model_name.replace('/', '-')}.jsonl"
