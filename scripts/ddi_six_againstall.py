...
# ============ LOAD DATASET ==============================
indexes = pd.read_csv('../data/6-list-unfiltered.txt', names=['row_ids']).row_ids.values
#print(indexes)
...
mask = [len(dd)==6 for dd in data.DrugBankID_sorted.values]
...
#=====================================================
log_file = f"../resultlogs/logger_logits_order_six_goldofsix_againstall_unfiltered_{model_name.replace('/', '-')}.jsonl"
